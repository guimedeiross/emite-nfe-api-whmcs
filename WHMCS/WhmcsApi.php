...
class WhmcsApi
{
    ...
    private function build_query_api(array $arrayValues): array
    {
    ...
    public function get_clients(?string $search = null, ?Status $status = null): array
    {
        $clients = array(
            'action' => 'GetClients',
            'responsetype' => 'json',
    ...
    public function get_clients_details(int $clientId = null, string $email = null): array
    {
        if (!$clientId && !$email) {
    ...
    public function get_invoice(int $invoiceId): array
    {
        $invoice = array(
            'action' => 'GetInvoice',
            'invoiceid' => $invoiceId,
    ...
    public function update_invoice_notes_default(int $invoiceId): array
    {
        $notes = $this->get_invoice($invoiceId)['notes'];
        if ($notes !== "") {
